        ...
        <div class="block">
            <div class="flex flex-col md:flex-col md:max-w-4xl max-w-sm mx-auto bg-white border border-green-900 my-5 shadow-2xl rounded-lg">
                ...
                <div class="p-4 md:w-1/2">
                    ...
                    <x-input id="type" class="block mt-1 w-full" type="text" name="type" :value="old('name')" autofocus />
                </div>

                <div class="p-4 md:w-1/2">
                    <h2 class="block font-medium text-sm text-gray-700">Description</h2>
                    <textarea id="description" class="block mt-1 w-full" type="text" name="description" :value="old('name')" autofocus /></textarea>
                </div>
